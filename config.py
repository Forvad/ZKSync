...
OKX_AMOUNT = [0.68, 0.68]  # обьём вывода ETH
...
WRAP_VALUE = [0.66, 0.67]  # объмы обёртывания
...
WORK_DEX = ['Syncswap', 'Izumi', 'Mute', 'Odos', 'Openocean', 'Syncswap', 'Zkswap']  # список площадок с какими работаем

DEX_TOKEN = ['ETH', 'BUSD']  # токены которые бьудут в работе 'ETH', 'USDC', 'BUSD'

DEX_VALUE = [5, 7]  # обёмы свапов в $

DEX_AMOUNT = [2, 2]  # колличество свапов
...
BALANCE_WALLET = [10, 10]  # остаток на балансе (если не нужно ничего осталять, оставить пустой список)
...
LENDING_VOLUME = [0.66, 0.67]  # бъём прогона в ETH

LENDING_AMOUNT = 3  # Колличество проходов
